...
from .source.maninetcluster.alignment import TrivialAlignment, Affine, Procrustes, CCA, CCAv2, \
...
from .source.maninetcluster.util import pairwise_error, Timer
# from viz import show_alignment
from .source.maninetcluster.warping import ctw, dtw, manifold_warping_linear, manifold_warping_nonlinear, manifold_warping_twostep
...
for name, aln in lin_aligners:r
    pyplot.figure()
    pyplot.clf()
    with Timer(name):
